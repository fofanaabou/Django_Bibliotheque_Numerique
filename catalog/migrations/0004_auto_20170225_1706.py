# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-02-25 17:06
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catalog', '0003_auto_20170225_1654'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a book genre (e.g.Science Fiction, French Poem) ', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Language',
